...
public class StoresListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        kidThings.add(new KidThing("Learning Shop", R.drawable.store_satara_01_thumbnail,
                "Toy store.",
        ...
        kidThings.add(new KidThing("Toys R Us", R.drawable.store_satara_01_thumbnail,
